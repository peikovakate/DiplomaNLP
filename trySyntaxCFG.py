# -*- coding: utf-8 -*-
"""
Created on Thu Mar 29 11:53:19 2018
    ...
    for x in phrase:
        ...
        for y in a:
            if (y.tag.POS == "NOUN") or (y.tag.POS == "ADJF") or (y.tag.POS == "PRTF"):
                ...
                f.writelines(strk)
#    f.writelines("NOUN[C=nomn, G=masc, NUM=sing, PER=3, NF=u'человек'] -> 'человека'\n\n\n")
    f.close()
                
    
#text = "Людина бачить"## сюда пишется словосочетание для разбора
text = "Человек видит"
...
cp = load_parser('grammars/book_grammars/test.fcfg', trace=1, cache=False) ## открываем нашу грамматику, смотрим на разбор в консоли или ещё где
